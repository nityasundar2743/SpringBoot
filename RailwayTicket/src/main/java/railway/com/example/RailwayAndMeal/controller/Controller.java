...
public class Controller {
	 ...
	 **/
		...
		if(bindingResult.hasErrors())
			throw new TicketBodyInvalidException("Invalid credentials!");
	...
	public void deleteTicketByPnr(@PathVariable long pnr) {
		railwayservice.deleteTicketByPnr(pnr);
	}
	
	@PutMapping("/ticket")
	public void updateTicket(@Valid @RequestBody Ticket newTicket, BindingResult bindingResult) {
		if(bindingResult.hasErrors())
			throw new TicketBodyInvalidException("Invalid credentials!");
		railwayservice.updateTicket(newTicket);
	}
